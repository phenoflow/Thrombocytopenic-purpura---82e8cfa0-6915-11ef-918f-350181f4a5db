...
(async () => {
  ...
  await fs.writeFile("thrombocytopenic-purpura-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("thrombocytopenic-purpura-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
